...
function HospiceCard({
  ...
  return (
    <details
      ...
      className="group rounded-[1.75rem] border border-[var(--line)] bg-[var(--surface)] p-5 [&_summary::-webkit-details-marker]:hidden"
    >
            ...
            <div className="grid gap-4 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
              ...
              <div className="grid gap-4">
                <div className="rounded-[1.5rem] border border-[rgba(64,99,74,0.14)] bg-[var(--success-soft)]/80 p-4 text-sm text-[var(--muted-strong)]">
                  ...
                  />
                  <div className="mt-3 flex flex-wrap gap-2">
                    {(trainingItems.length ? trainingItems : ["No especificada"]).map((training) => (
                      <span
                ...
                <div className="rounded-[1.5rem] border border-[rgba(64,99,74,0.14)] bg-[var(--success-soft)]/80 p-4 text-sm text-[var(--muted-strong)]">
                  ...
                  />
                  <div className="mt-3 flex flex-wrap gap-2">
                    {(topicItems.length ? topicItems : resource.services.slice(0, 8)).map((topic) => (
                      <span
              ...
              return (
                resource.category === "hospicio" ? (
                  <HospiceCard
                    ...
                    onToggle={(nextOpen) =>
                      setOpenResourceId(nextOpen ? resource.id : null)
                    }
                  />
                ) : (
